...
struct L {
    ...
    var monthly: String { t("월간", "Monthly", "月間", "Mensual", "Mensuel") }
    ...
    func limitsAccount(_ a: String) -> String { t("계정 \(a)", "Account \(a)", "アカウント \(a)", "Cuenta \(a)", "Compte \(a)") }
    ...
    var opencodeGoFiveHour: String { t("OpenCode Go 5시간", "OpenCode Go 5-hour", "OpenCode Go 5時間", "OpenCode Go 5 horas", "OpenCode Go 5 h") }
    var opencodeGoWeekly: String { t("OpenCode Go 주간", "OpenCode Go weekly", "OpenCode Go 週間", "OpenCode Go semanal", "OpenCode Go hebdo") }
    var opencodeGoMonthly: String { t("OpenCode Go 월간", "OpenCode Go monthly", "OpenCode Go 月間", "OpenCode Go mensual", "OpenCode Go mensuel") }

    // MARK: 폰·위젯 한도 라벨 (compact — 프로바이더 접두어 포함, Mac 이 현지화해 페이로드로 보낸다)
    var phoneClaude5h: String { t("Claude 5시간", "Claude 5h", "Claude 5時間", "Claude 5h", "Claude 5 h") }
    var phoneClaudeWeekly: String { t("Claude 주간", "Claude Weekly", "Claude 週間", "Claude semanal", "Claude hebdo") }
    var phoneClaudeOpusWeekly: String { t("Claude Opus 주간", "Claude Opus Weekly", "Claude Opus 週間", "Claude Opus semanal", "Claude Opus hebdo") }
    var phoneClaudeSonnetWeekly: String { t("Claude Sonnet 주간", "Claude Sonnet Weekly", "Claude Sonnet 週間", "Claude Sonnet semanal", "Claude Sonnet hebdo") }
    /// 모델별 주간(weekly_scoped) — "Claude 주간 <모델>". 모델명이 없으면 접미어만.
    func phoneClaudeScoped(model: String?) -> String {
        guard let model else { return t("Claude 주간(모델별)", "Claude Weekly (scoped)", "Claude 週間（モデル別）", "Claude semanal (por modelo)", "Claude hebdo (par modèle)") }
        return t("Claude 주간 \(model)", "Claude Weekly \(model)", "Claude 週間 \(model)", "Claude semanal \(model)", "Claude hebdo \(model)")
    }
    var phoneCodex: String { t("Codex 5시간", "Codex 5h", "Codex 5時間", "Codex 5h", "Codex 5 h") }
    var phoneCodexSecondary: String { t("Codex 주간", "Codex Weekly", "Codex 週間", "Codex semanal", "Codex hebdo") }
    var phoneGo5h: String { t("Go 5시간", "Go 5h", "Go 5時間", "Go 5h", "Go 5 h") }
    var phoneGoWeekly: String { t("Go 주간", "Go Weekly", "Go 週間", "Go semanal", "Go hebdo") }
    var phoneGoMonthly: String { t("Go 월간", "Go Monthly", "Go 月間", "Go mensual", "Go mensuel") }
