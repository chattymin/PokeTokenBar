...
struct L {
    ...
    var growthCostLabel: String { t("컴패니언 성장 비용", "Companion growth cost", "育成コスト", "Costo de crecimiento", "Coût de croissance", "Custo de crescimento", "Begleiter-Wachstumskosten") }
    var growthCostHint: String { t("부화·진화·졸업에 필요한 토큰의 비율 — 10%면 커먼 1단계 진화가 125M → 12.5M", "Share of tokens needed to hatch, evolve and graduate — at 10%, a common's stage-1 evolution costs 12.5M instead of 125M", "孵化・進化・卒業に必要なトークンの割合 — 10%ならノーマル1段階目の進化が 125M → 12.5M", "Proporción de tokens para eclosionar, evolucionar y graduar — al 10%, la 1.ª evolución común cuesta 12,5M en vez de 125M", "Part des jetons requise pour éclore, évoluer et diplômer — à 10 %, la 1re évolution commune coûte 12,5M au lieu de 125M", "Fração de tokens para chocar, evoluir e formar — a 10%, a 1ª evolução comum custa 12,5M em vez de 125M", "Anteil der Tokens zum Schlüpfen, Entwickeln und Abschied — bei 10% kostet die 1. Entwicklung eines gewöhnlichen Pokémon 12,5M statt 125M") }
