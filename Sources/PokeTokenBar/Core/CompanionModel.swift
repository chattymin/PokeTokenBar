...
enum PokemonNature: String, Codable, Sendable, CaseIterable {
    ...
    func name(_ lang: AppLanguage) -> String {
        ...
        case .lonely:  names = ("외로움", "Lonely", "さみしがり", "Huraña", "Solitária")
        case .brave:   names = ("용감", "Brave", "ゆうかん", "Audaz", "Corajosa")
        case .adamant: names = ("고집", "Adamant", "いじっぱり", "Firme", "Firme")
        ...
        case .relaxed: names = ("무사태평", "Relaxed", "のんき", "Plácida", "Relaxada")
        case .impish:  names = ("장난꾸러기", "Impish", "わんぱく", "Agitada", "Travessa")
        case .lax:     names = ("촐랑", "Lax", "のうてんき", "Floja", "Displicente")
        ...
        case .quirky:  names = ("변덕", "Quirky", "きまぐれ", "Rara", "Peculiar")
        }
