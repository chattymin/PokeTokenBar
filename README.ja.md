...
しんかしきったポケモンのけいけんちは行き場がありませんでした。いまはそれが<b>じぶんのラインのタマゴ</b>になります — リザードンはヒトカゲのタマゴをもってくるので、とばした前のすがたも図鑑にうめられます。ホーム画面のおしらせをおすと、すぐ下のふ化スロットにそのまま入ります。けいけんちはタマゴひとつぶんでとまり、うけとると0にもどるので、タマゴがいくつもたまることはありません。
</td>
